...
export default function Example() {
    ...
    const toolInfo = {
        ...
        description:
            'Like tweets that include a specific phrase. You can choose how many tweets you want to like with this tool.',
        icon: HeartIcon,
    }
