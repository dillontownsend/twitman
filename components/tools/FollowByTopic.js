    ...
    const twitFunction = async () => {
        if (q.length < 1) {
            ...
            const res = await fetch(
                'http://localhost:3000/api/twitter/FollowByTopic',
                {
                    method: 'POST',
                    headers: {
                                                ...
                                                {response ? (
                                                    <>
                                                        {success ? (
                                                            ...
                                                            <>
                                                                <h3 className='text-red-500 text-xl'>Something went wrong :/</h3>
                                                            </>
                                                        )}
                                                    </>
                                                ) : (
                                                    <>
                                                        <p className="text-sm text-gray-500">
                                                            ...
                                                            the users that recently tweet
                                                            something with a
                                                            specific phrase. By
                                                            default, the tool
                                                            looks up the 50 most
                                                            recent tweets to follow. You
                                                            can change this
                                                            number with the
                                                            count parameter.
                                                        </p>
